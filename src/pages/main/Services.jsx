...
export default function Services(){
    return(
        <div className='home-section service-wraper'>
            ...
            <div className="home-section__content service-content">
                {categories.map((category, index) => (
                    <Link className="category-card" style={{backgroundImage:`url(${category.image})`}} key={index} to={`/items/${category.url}`}>
